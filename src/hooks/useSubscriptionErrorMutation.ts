...
export function useSubscriptionErrorMutation(error: any) {
  const navigate = useNavigate();

  useEffect(() => {
    console.log("useSubscriptionErrorMutation - error:", error);
    ...
    if (
      ...
      console.warn(
        "Erro de assinatura na mutation:",
      ...
      if (window.location.pathname !== redirectUrl) {
        console.log(
          "useSubscriptionErrorMutation - redirecionando para:",
          redirectUrl
        );
    ...
    if (
      ...
      // Mostrar mensagem de erro
      console.warn(
        "Erro de assinatura na mutation (402):",
        subscriptionError.message
      );
      ...
      if (window.location.pathname !== redirectUrl) {
        console.log(
          "useSubscriptionErrorMutation (402) - redirecionando para:",
          redirectUrl
        );
        navigate(redirectUrl);
      }
